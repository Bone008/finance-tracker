...
export class FilterState {
  ...
  followFragment(paramName: string, route: ActivatedRoute, router: Router) {
    observeFragment(paramName, this.value$, route, router)
      .subscribe(value => this.setValueNow(value));
  }
}
