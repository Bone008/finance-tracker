...
# Adapted from: https://github.com/hoffie/dkb-visa
# Changes:
#   * Also write CSV output in UTF-8.
...
# This is the encoding that DKB uses for their CSV files.
CSV_ENCODING = 'latin1'
...
def download_transactions(cli, args, fetcher):
    ...
    for idx in range(len(args.cardid)):
        ...
        if args.csv:
            ...
            f.write(csv_text.encode(CSV_OUTPUT_ENCODING))
        else:
            card_name = None
            if args.qif_account:
